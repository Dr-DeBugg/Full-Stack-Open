...
const Anecdote = ({ anecdotes }) => {
  ...
  const anecdote = anecdotes.find(n => n.id === id.toString())
  return (
    <div>
...
const handleReset = () => {
  content.palautareset.reset()
  author.palautareset.reset()
  info.palautareset.reset()
}
...
const App = () => {
  ...
  //no use in app - could be deleted?
  // const padding = {
  //   paddingRight: 5
  // }
